...
void Abs_Key_Key0_Event_Press(void)
{
    printf("Abs_Key_Key0_Event_Press! \n");
}
void Abs_Key_Key0_Event_Release(void)
{
    printf("Abs_Key_Key0_Event_Release! \n");
}
void Abs_Key_Key0_Event_Single_Click(void)
{
    ...
    ret = Drv_AT24C02_Read(0x08, readData, 8);
...
void Abs_Key_Key0_Event_Double_Click(void)
{
    ...
    Drv_AT24CXX_Status_t ret = DRV_AT24CXX_SUCCESS;
    ret = Drv_AT24C02_Write(0x08, &writeData[0], 8);
    if (ret == DRV_AT24CXX_SUCCESS)
    {
...
void Abs_Key_Key1_Event_Press(void)
{
    printf("Abs_Key_Key1_Event_Press! \n");
}
void Abs_Key_Key1_Event_Release(void)
{
    printf("Abs_Key_Key1_Event_Release! \n");
}
...
void Abs_Key_Key2_Event_Press(void)
{
    printf("Abs_Key_Key2_Event_Press! \n");
}
void Abs_Key_Key2_Event_Release(void)
{
    printf("Abs_Key_Key2_Event_Release! \n");
}
...
void Abs_Key_Key3_Event_Press(void)
{
    printf("Abs_Key_Key3_Event_Press! \n");
}
void Abs_Key_Key3_Event_Release(void)
{
    printf("Abs_Key_Key3_Event_Release! \n");
}
